...
# Fix package installation conflicts by adding --force-overwrite flag
echo "🔧 添加 --force-overwrite 标志以解决包文件冲突..."
sed -i 's/$(TARGET_DIR)) install/$(TARGET_DIR)) install --force-overwrite/' openwrt/package/Makefile || true
